...
class GlobalTestOpenAcademySession(TransactionCase):
	...
	# NOTA:A partir del minuto 1:39 del video, el rgrep workflow . --include=*.py | grep tests no mostró el método
	# signal_workflow, luego openacademy_session_workflow.xml no está en el proyecto que he manejado en el curso
	# AttributeError: 'openacademy.session' object has no attribute 'signal_workflow'
	# Min 1:48 la funcionalidad mostrada no coincide con el openacademy de mi curso.
